...
class TaskListDaoTest {
    ...
    @Test
    public void getAllTaskListsShouldReturnAllTaskLists(){
        List<TaskListModel> taskLists = taskListDao.getAllTaskLists(true);
    ...
    public void getAllTaskListsShouldReturnAllTaskListsWithoutItems(){
        List<TaskListModel> taskLists = taskListDao.getAllTaskLists(false);
    ...
    public void createTaskListShouldCreateANewTaskList(){
        String taskListName = "Some new tasklist";
        String userName = "Bob";

        UserModel user = userDao.getUserByName(userName);

        TaskListModel taskList = taskListDao.createTaskList(user.id(), taskListName);
        assertNotNull(taskList);
        assertEquals(taskListName, taskList.listName());
        assertEquals(user.id(), taskList.createdByUser());
